...
extension EmptyCollection: RandomAccessCollection, MutableCollection
{
    ...
    {
        get { _preconditionFailure("Index out of range") }
        set { _preconditionFailure("Index out of range") }
    }
    ...
    public subscript(bounds: Range<Index>) -> SubSequence
    {
        get
        {
            _debugPrecondition(bounds.lowerBound == 0 && bounds.upperBound == 0, "Index out of range")
            return self
        }
        set
        {
    ...
    {
        _debugPrecondition(i == startIndex && limit == startIndex,^"Index out of range")
        return n == 0 ? i : nil
    }
