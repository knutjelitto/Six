...
extension Array {
  ...
  /// `0 ≤ index < count`.
  public // @testable
  func _checkSubscript(_ index: Int, wasNativeTypeChecked: Bool) -> _DependenceToken
  {
...
extension Array: RangeReplaceableCollection {
  ...
  internal mutating func _createNewBuffer(bufferIsUnique: Bool, minimumCapacity: Int, growForAppend: Bool)
  {
...
extension Array {
  ...
  public mutating func withUnsafeMutableBytes<R>(
    ...
    return try self.withUnsafeMutableBufferPointer({ return try body(UnsafeMutableRawBufferPointer($0)) })
  }
