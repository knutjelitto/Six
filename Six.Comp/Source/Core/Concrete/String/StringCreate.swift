...
extension String
{
  ...
  where Input.Element == Encoding.CodeUnit {
    ...
    if let contigBytes = input as? _HasContiguousBytes, contigBytes._providesContiguousBytesNoCopy
    {
  ...
  internal static func _fromInvalidUTF16(_ utf16: UnsafeBufferPointer<UInt16>) -> String
  {
