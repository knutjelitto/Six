...
internal struct _HashTable
{
    ...
    {
        _internalInvariant(bucketCount > 0 && bucketCount & (bucketCount - 1) == 0, "bucketCount must be a power of two")
    ...
    {
        get { return bucketMask &+ 1 }
    }

    internal var wordCount: Int
    {
        get { return _UnsafeBitset.wordCount(forCapacity: bucketCount) }
    }
}
