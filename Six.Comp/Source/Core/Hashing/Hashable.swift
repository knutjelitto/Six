...
internal func Hashable_isEqual_indirect<T: Hashable>(_ lhs: UnsafePointer<T>, _ rhs: UnsafePointer<T>) -> Bool
{
    return lhs.pointee == rhs.pointee
}

// Called by the SwiftValue implementation.
internal func Hashable_hashValue_indirect<T: Hashable>(_ value: UnsafePointer<T>) -> Int
{
