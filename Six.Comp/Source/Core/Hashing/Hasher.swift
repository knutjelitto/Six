...
public struct Hasher
{
    ...
    {
        get { return _swift_stdlib_Hashing_parameters.deterministic }
    }
    ...
    internal static var _executionSeed: (UInt64, UInt64)
    {
        get
        {
            ...
            // trade-off.
            return (_swift_stdlib_Hashing_parameters.seed0, _swift_stdlib_Hashing_parameters.seed1)
        }
    }
    ...
    internal static func _hash(seed: Int, bytes value: UInt64, count: Int) -> Int
    {
        _internalInvariant(count >= 0 && count < 8)
        var state = _State(seed: seed)
    ...
    internal static func _hash(seed: Int, bytes: UnsafeRawBufferPointer) -> Int
    {
