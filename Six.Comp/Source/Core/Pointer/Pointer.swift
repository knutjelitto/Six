...
/// UnsafeMutablePointer, UnsafePointer, UnsafeRawPointer and UnsafeMutableRawPointer.
public protocol _Pointer : Hashable, Strideable, CustomDebugStringConvertible, CustomReflectable
{
...
public // COMPILER_INTRINSIC
func _convertConstStringToUTF8PointerArgument<ToPointer: _Pointer>(_ str: String) -> (AnyObject?, ToPointer)
{
