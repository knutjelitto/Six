...
public struct LazyFilterSequence<Base: Sequence>
{
    ...
    internal init(_base base: Base, _ isIncluded: @escaping (Base.Element) -> Bool)
    {
        self._base = base
...
extension LazyFilterSequence
{
    ...
    public struct Iterator
    {
        ...
        internal init(_base: Base.Iterator, _ isIncluded: (Base.Element) -> Bool)
        {
            self._base = _base
            self._predicate = isIncluded
        }
...
extension LazyFilterCollection: Collection
{
    ...
    internal func _ensureBidirectional(step: Int)
    {
        ...
        if step < 0
        {
            _ = _base.index(_base.endIndex, offsetBy: step, limitedBy: _base.startIndex)
        }
    }
...
extension LazySequenceProtocol
{
    ...
    ///   elements.
    public __consuming func filter(_ isIncluded: (Elements.Element) -> Bool) -> LazyFilterSequence<Self.Elements>
    {
...
extension LazyFilterSequence
{
    public __consuming func filter(_ isIncluded: @escaping (Element) -> Bool) -> LazyFilterSequence<Base>
    {
