...
extension LazySequenceProtocol
{
    ...
    ///
    /// - Complexity: O(1)
    public func flatMap<SegmentOfResult>(_ transform: (Elements.Element) -> SegmentOfResult)
    ...
    ///
    /// - Complexity: O(1)
    public func compactMap<ElementOfResult>(_ transform: (Elements.Element) -> ElementOfResult?)
