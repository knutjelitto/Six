...
public struct LazyPrefixWhileSequence<Base: Sequence>
{
    ...
    internal init(_base: Base, predicate: (Element) -> Bool)
    {
        self._base = _base
...
extension LazyPrefixWhileSequence
{
    ...
    public struct Iterator
    {
        ...
        internal init(_base: Base.Iterator, predicate: (Element) -> Bool)
        {
            self._base = _base
            self._predicate = predicate
        }
...
extension LazySequenceProtocol
{
    ...
    ///   called again.
    public __consuming func prefix(while predicate: (Elements.Element) -> Bool) -> LazyPrefixWhileSequence<Self.Elements>
    {
