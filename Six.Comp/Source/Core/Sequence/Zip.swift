...
public func zip<Sequence1, Sequence2>(_ sequence1: Sequence1, _ sequence2: Sequence2) -> Zip2Sequence<Sequence1, Sequence2>
{
...
extension Zip2Sequence.Iterator: IteratorProtocol
{
    ...
    public mutating func next() -> Element?
    {
        ...
        guard let element1 = _baseStream1.next(), let element2 = _baseStream2.next()
        else
        {
            _reachedEnd = true
            return nil
