...
{
    public class Conditional : Base, IExpression
    {
        public Conditional(IScoped outer, IOperator @operator, IExpression condition, IExpression ifTrue, IExpression isFalse)
            : base(outer)
        {
            Operator = @operator;
            Condition = condition;
