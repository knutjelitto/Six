namespace SixComp.Sema
{
    public static class Strings
    {
        ...
        public static class Head
        {
            ...
            public static readonly string Deinit = "deinit:";
            ...
            public static readonly string Fixitivity = "fixitivity:";
            ...
            public static readonly string HigherThan = "higher-than:";
            public static readonly string Identifier = "identifier:";
            public static readonly string If = "if:";
            public static readonly string IfFalse = "if-false:";
            public static readonly string IfTrue = "if-true:";
            public static readonly string Import = "import:";
            public static readonly string Infix = "infix:";
            public static readonly string InfixList = "infix-list:";
            ...
            public static readonly string Precedence = "precedence:";
            ...
            public static readonly string SetterName = "setter-name:";
