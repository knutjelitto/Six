...
namespace SixComp
{
    ...
    public enum ToKind
    {
        ...
        [Rep("precedencegroup", ToClass.Keyword)] KwPrecedencegroup,
        ...
        [Rep("higherThan", ToClass.Keyword)] KwHigherThan,
        [Rep("lowerThan", ToClass.Keyword)] KwLowerThan,
        [Rep("assignment", ToClass.Keyword)] KwAssignment,
        [Rep("associativity", ToClass.Keyword)] KwAssociativity,
        [Rep("left", ToClass.Keyword)] KwLeft,
