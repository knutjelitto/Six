...
namespace SixPeg.Common.Tracing
{
    ...
    {
        private readonly RuleStats cacheHitStats = new RuleStats();
        private readonly Stack<RuleStackEntry> ruleStack = new Stack<RuleStackEntry>();
        private readonly Dictionary<string, RuleStats> stats = new Dictionary<string, RuleStats>();
